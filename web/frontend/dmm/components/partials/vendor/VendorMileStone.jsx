    ...
    <div className="ps-section--vendor ps-vendor-milestone">
        <div className="container">
            <div className="ps-section__header">
                <p>How it works</p>
                <h4>
                    Easy to start selling online on DMM just 4 simple steps
                </h4>
            </div>
            <div className="ps-section__content">
                <div className="ps-block--vendor-milestone">
                    <div className="ps-block__left">
                        ...
                        <ul>
                            ...
                            <li>
                                Our DMM Advisors will help you at every
                    ...
                    <div className="ps-block__right">
                        <img src="/static/img/vendor/milestone-1.png" alt="dmm" />
                    </div>
                ...
                <div className="ps-block--vendor-milestone reverse">
                    ...
                    <div className="ps-block__right">
                        <img src="/static/img/vendor/milestone-2.png" alt="dmm" />
                    </div>
                    <div className="ps-block__number">
                        <span>2</span>
                    </div>
                ...
                <div className="ps-block--vendor-milestone">
                    ...
                    <div className="ps-block__right">
                        <img src="/static/img/vendor/milestone-3.png" alt="dmm" />
                    </div>
                    <div className="ps-block__number">
                        <span>3</span>
                    </div>
                ...
                <div className="ps-block--vendor-milestone reverse">
                    ...
                    <div className="ps-block__right">
                        <img src="/static/img/vendor/milestone-4.png" alt="dmm" />
                    </div>
                    <div className="ps-block__number">
                        <span>4</span>
                    </div>
