                ...
                <div className="row">
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="mailto:contact@dmm.novatic.vn">
                                    contact@dmm.novatic.vn
                                </a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                ...
                                <a href="#">career@dmm.novatic.vn</a>
                            </p>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">customercare@dmm.novatic.vn</a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">vendorsupport@dmm.novatic.vn</a>
